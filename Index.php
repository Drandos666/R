...
<body>
    ...
    <div class="container-fluid">
        <nav class="navbar navbar-light bg-light">
            <a class="navbar-brand" href="#">
                <img src="img/90.jpg" width="30" height="30" class="d-inline-block align-top" alt=""> Los 90s</a>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                <a class="nav-item nav-link" href="#">Ingresar (Adm)</a>
    ...
    <div class="card-deck">
        <div class="card">
            <img class="card-img-top img-thumbnail" src="img/1.jpg" alt="Card image cap">
                <div class="card-body">
                <h5 class="card-title">Artesanias Mexicanas</h5>
        ...
        <div class="card">
            <img class="card-img-top img-thumbnail" src="img/2.jpg" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title">Cinturón Rock hebilla doble perno</h5>
        ...
        <div class="card">
            <img class="card-img-top img-thumbnail" src="img/3.jpg" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title">Camisa Hippie</h5>
    ...
    <div class="card-deck">
        <div class="card">
            <img class="card-img-top img-thumbnail" src="img/4.jpg" alt="Card image cap">
                <div class="card-body">
                <h5 class="card-title">Conjunto de Arte Moderno</h5>
        ...
        <div class="card">
            <img class="card-img-top img-thumbnail" src="img/5.jpg" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title">Li Xianting Está Nadando</h5>
        ...
        <div class="card">
            <img class="card-img-top img-thumbnail" src="img/6.jpg" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title">Homenaje a Obregón</h5>
    ...
    <div class="container mt-5 pt-5">
    <H2>Lugares Exoticos</H2>
    <div class="card-deck">
        <div class="card">
            <img class="card-img-top img-thumbnail" src="img/7.jpg" alt="Card image cap">
                <div class="card-body">
                <h5 class="card-title">Aldea Shirakawa-go</h5>
        ...
        <div class="card">
            <img class="card-img-top img-thumbnail" src="img/8.jpg" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title">Dunas de arena de Tottori</h5>
        ...
        <div class="card">
            <img class="card-img-top img-thumbnail" src="img/9.jpg" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title">Santuario Itsokushima</h5>
    ...
    <div class="card-deck">
        <div class="card">
            <img class="card-img-top img-thumbnail" src="img/10.jpg" alt="Card image cap">
                <div class="card-body">
                <h5 class="card-title">Kogals</h5>
        ...
        <div class="card">
            <img class="card-img-top img-thumbnail" src="img/11.jpg" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title">Bakalas</h5>
        ...
        <div class="card">
            <img class="card-img-top img-thumbnail" src="img/12.jpg" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title">Reggaetoneros</h5>
    ...
    <div class="card-deck">
        <div class="card">
            <img class="card-img-top img-thumbnail" src="img/13.jpg" alt="Card image cap">
                <div class="card-body">
                <h5 class="card-title">Megadeth - Rust In Peace</h5>
        ...
        <div class="card">
            <img class="card-img-top img-thumbnail" src="img/14.jpg" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title">Slayer - Seasons In The Abyss</h5>
        ...
        <div class="card">
            <img class="card-img-top img-thumbnail" src="img/15.jpg" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title">Pantera - Cowboys From Hell</h5>
